...
export const ProjectModal: React.FC<ProjectModalProps> = ({ project, onClose }) => {
  ...
  return (
    ...
    >
      <div className="relative w-full max-w-4xl rounded-2xl sm:rounded-3xl border border-champagne/30 bg-[#0a0a0f] p-4 sm:p-6 md:p-8 lg:p-10 shadow-2xl overflow-hidden my-auto space-y-4 sm:space-y-5 md:space-y-6 max-h-[90vh] overflow-y-auto">
